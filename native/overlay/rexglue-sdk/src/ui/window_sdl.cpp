...
// ANDROID PORT (naughtybear-restuff-android): a janela SDL no Android vive no
// SDLActivity Java; a superfície Vulkan é criada a partir do ANativeWindow
// exposto via SDL_PROP_WINDOW_ANDROID_WINDOW_POINTER.
