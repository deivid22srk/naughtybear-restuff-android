...
#define XE_UI_VULKAN_FEATURE_IMPLIED(name) \
  ...
  // Port Android: capability reportada incondicionalmente (o renderer
  // nativo do jogo decide BC upload vs CPU decode com base nela; habilitar
  // no VkDevice é inócuo quando o device não suporta).
  XE_UI_VULKAN_FEATURE(textureCompressionBC)
