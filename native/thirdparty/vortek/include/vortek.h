...
// Port Android (naughtybear-restuff-android): NO UPSTREAM o cliente é buildado
// no rootfs glibc do Winlator (sem __ANDROID__), então "ifdef __ANDROID__"
// marcava unicamente o SERVIDOR. Neste port o cliente também é buildado com o
// NDK (__ANDROID__ definido) — o bloco abaixo foi REMOVIDO para não compilar o
// cliente em modo servidor. O servidor (../vortekrenderer) define VT_SERVER
// explicitamente no próprio vortek.h via __ANDROID__ — inalterado.
