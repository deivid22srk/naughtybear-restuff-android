...
#define REQUEST_CODE_VK_CALL_COUNT 256
...
// Port Android (naughtybear-restuff-android): surface Android real no host.
// Códigos NOVOS adicionados AO FINAL — a numeração existente não muda, então
// o array handleRequestFuncs[] permanece alinhado por posição (entradas novas
// também no final).
#define REQUEST_CODE_VK_CREATE_ANDROID_SURFACE_KHR 354
#define REQUEST_CODE_VK_DESTROY_SURFACE_KHR 355
